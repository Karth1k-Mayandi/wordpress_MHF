				...
				if (isset($templates) && count($templates) > 0 && count($templates[0]) > 0)
				{
					...
					{		
						...
						if (isset($data->usetemplateforgrid) && strtolower($data->usetemplateforgrid) === 'true' && !empty($data->templateforgrid))
						{
							...
							$gridtext = str_replace('__TAGNAMES__',  implode(', ', $tag_names), $gridtext);
							$gridtext = str_replace('__TAGNAMESANDLINKS__',  implode(', ', $tag_names_with_links), $gridtext);
						...
						if (isset($data->usetemplatefortextoverlay) && strtolower($data->usetemplatefortextoverlay) === 'true' && !empty($data->templatefortextoverlay))
						{
							...
							$itemtext = str_replace('__TAGNAMES__',  implode(', ', $tag_names), $itemtext);
							$itemtext = str_replace('__TAGNAMESANDLINKS__',  implode(', ', $tag_names_with_links), $itemtext);
